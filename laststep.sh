...
########################################################################
###################                                  ###################
###################  Gatekeeper Install Script Part2 ###################
###################                                  ###################
########################################################################
#
...
echo -e "\e[0;31m#\e[0m             Finishing Gatekeeper Installation.             \e[0;31m#\e[0m"
echo -e "\e[0;31m#\e[0m                                                           \e[0;31m#\e[0m"
...
echo -e "\e[0;31m[+] After reboot, if your hwclock time (UTC) is incorrect, run /root/Gatekeeper/fixclock.sh\e[0m"
echo ""
